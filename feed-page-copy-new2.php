...
//print_r($display);
        ...
        <div class="main-content" id="page-load-ref">
            ...
            <div class="main-content-inn col-three main-content-full usr-feed-page usr-feed-page-nw usr-feed-pge-new" >
                <div class="col-first-side jq_sidebar_fix">
			  ...
			  success: function(data)
		          {
		           ...
		           $('#alert-msg').html(data).show();
                    ...
                    <div class="col-third   animated fadeInRight" id="container">
...
<img src="images/fr-li-icon.png" alt="user image"></a>
</span><p class="user-nm"><a href="friend-list.php">Adopt a Pet</a></p>
</div>
<div class="plus-i"><a href="#"><i class="fa fa-plus"></i></a></div>
</h2>
<div class="p-sd-content">
<div class="p-sd-box">
<div class="pt-image"><img src="images/user_image09.jpg" /></div>
<div class="pt-content-btm">
<div class="pt-anc">
<div class="pt-anc-l"><a href="#">John Roger</a></div>
<div class="pt-anc-r"><a href="#" class="rpl">Reply</a></div>
</div>
<div class="pt-dsc">
<p>
Labra Dog, 2 yrs, Male is looking for lovely and caring house
</p>
</div>
</div>
</div>
...
<span class="user-icn-img"><a href="#">
<img src="images/fr-li-icon.png" alt="user image"></a>
</span><p class="user-nm"><a href="friend-list.php">Pet Mate</a></p>
</div>
<div class="plus-i"><a href="#"><i class="fa fa-plus"></i></a></div>
</h2>
<div class="p-sd-content">
