...
if(isset($_POST['id'])) {
	...
	$likechq="SELECT * FROM group_likes WHERE post_id='$_POST[id]' AND liker_unique_id='$uniqueid'";
...
if($count>0) {
	...
	$unlikeqry="DELETE FROM group_likes WHERE post_id='$_POST[id]' AND liker_unique_id='$uniqueid'";
	$unlikerun=mysqli_query($conn,$unlikeqry);
	echo "Like|";
}
else {
	
	$likeqry="INSERT INTO group_likes(post_id,liker_unique_id)VALUES('$_POST[id]','$uniqueid')"; 
	$likerun=mysqli_query($conn,$likeqry);
	echo "Unlike|";
}
$totallikes=mysqli_query($conn,"SELECT * FROM group_likes WHERE post_id='$_POST[id]'");
...
$cominsqry="INSERT INTO group_comments(post_id,commenter_unique_id,comment)VALUES('$_POST[commentid]','$uniqueid','$_POST[commenttext]')";
$commentinsert=mysqli_query($conn,$cominsqry);	



												
								$commentqry=mysqli_query($conn,"SELECT * FROM group_comments WHERE post_id='$_POST[commentid]'");
