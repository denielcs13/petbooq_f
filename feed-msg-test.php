...
echo "<span class='user-icn-img'><img src='" . $row['profile_pic'] . "' alt='user image'><span class='fr-nm'><a href='msg-test.php?id=" . $row['pet_unique_id'] . "' class='frn_profile'>" . $row['pet_name'] . "</a></span></span>";
                                                } else {
