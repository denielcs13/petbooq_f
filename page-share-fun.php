...
$chk_share=mysqli_query($conn,"SELECT * FROM shares WHERE post_id='$_POST[pid]' AND sharer_id='$parent_id' AND share_with_id='$name' AND type='page'");

	if(mysqli_num_rows($chk_share)>0) {
		echo "You Have Already Shared This Post With ".$spet_name['pet_name']."&nbsp;&nbsp;&nbsp;";
		continue;	
	} 
	$shareqry="INSERT INTO shares(post_id,sharer_id,share_with_id,type,time)VALUES('$_POST[pid]','$parent_id','$name','page','$share_datetime')";
