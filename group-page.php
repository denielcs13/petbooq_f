...
<li><a href="group-members-list.php?id=<?php echo "$gp_id";?>"><i class="fa fa-users"></i>Members</a></li>
...
<h4>Members</h4>
<div class="fr-t-l">
<span class="user-icn-img"><img src="6936069/profile_pic/golden-retrievers.jpg" alt="user image"><span class="fr-nm"><a href="#" class="frn_profile">Gregory12</a></span></span>
</div>
<div class="fr-t-l">
<span class="user-icn-img"><img src="6936069/profile_pic/golden-retrievers.jpg" alt="user image"><span class="fr-nm"><a href="#" class="frn_profile">Gregory12</a></span></span>
</div>
...
<span class="ad-mem-btn"><button class="cls">X</button><button>Add Member</button></span>
</div>
