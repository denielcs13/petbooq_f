...
//	                        $par_name=mysqli_query($conn,"SELECT * FROM user_inf WHERE pet_unique_id='$postres[user_id_fk]'");
                           $par_name=mysqli_query($conn,"SELECT pet_name, profile_pic, pet_unique_id FROM user_inf WHERE pet_unique_id = '$postres[user_id_fk]' UNION SELECT company_name, profile_image, business_uniqueid FROM business
WHERE business_uniqueid = '$postres[user_id_fk]' UNION SELECT ngo_name, profile_image, ngo_unique_id FROM ngo_resgitration WHERE ngo_unique_id = '$postres[user_id_fk]'");
                                ...
                                <div class="one-col-post" id="<?= $postres['e_update_id'] ?>">
...
<a href="aj_event.php?id=<?= $postres['e_update_id'] ?>&im=<?= urlencode($post_images[$i]) ?> .ajcontent" data-featherlight="ajax">
...
<li class="pb-image-box">
<a href="aj_event.php?id=<?= $postres['e_update_id'] ?>&vid=<?= urlencode($post_videos[$i]) ?> .ajcontent" data-featherlight="ajax">
<video controls>
