...
var NoResultsLabel = "No Results";
   ...
   else
   {
     ...
     var ide=ui.item.id;
     if(ui.item.owner=="Eshop"||ui.item.owner=="Brand product"||ui.item.owner=="Shop"||ui.item.owner=="Animal Service"||ui.item.owner=="Medical Service"||ui.item.owner=="Other") {
     location.href="business-page-new-user.php?id="+ide;
    // console.log("Business location");
     }
     if(ui.item.owner=="Group")
     {
      location.href="group2.php?id="+ide;
     }
     else
     {
