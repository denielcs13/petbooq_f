...
require './dbcon.php';
				...
				$profileqry=mysqli_query($conn,"SELECT * FROM ngo_resgitration WHERE ngo_unique_id ='$parent_id'");
...
<a href="ngo-edit.php" class="edit"><i class="fa fa-edit"></i>  Update Profile Picture</a></div>
						</div>
						
<div class="pet-info">
<p><strong>
<span class="img-icon"><img src="images/ngo-icon.png"></span> 
<span class="label"> NGO Name :</span> 
<span class="u-n-d"><?= $profileinfo['ngo_name']; ?></span></strong></p>
</div>
<div class="pet-info">
<p><strong>
...
<div class="pet-info">
<p><strong>
<span class="img-icon"><img src="images/email-icon.png"></span> 
<span class="label"> Email :</span> 
<span class="u-n-d"><?= $profileinfo['email']; ?></span></strong></p>
</div>
<div class="pet-info">
<p><strong>
<span class="img-icon"><img src="images/description-icon.png"></span> 
<span class="label"> Description :</span> 
<span class="u-n-d"><?= $profileinfo['ngo_desc']; ?></span></strong></p>
</div>
</div>
