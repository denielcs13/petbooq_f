...
$(function(){
    ...
    $("body").css({position: "fixed", right: "60%", width: "100%",transition: '.4s ease'});
    });
});

$(function(){
    $('.sdbr-del-btn').click(function(){
        $(".op-div").css({
            'display' : 'none'
       });
...
<div class="op-btn"><i class="fa fa-bars" aria-hidden="true"></i></div>
<div class="col-first-side op-div" style="display:none">
<div class="sdbr-del"><i class="fa fa-window-close sdbr-del-btn" aria-hidden="true"></i></div>
...
<?php if (!isset($_SESSION['login_user'])) { ?>
  ...
  ?>
	...
	if(isset($_SESSION['login_user']) &&  isset($_SESSION['pet_unique_id'])) {
		...
		echo "<li><a href ='feed-page-copy.php'  class='hdr-post-anc hm-icon'>Home</a></li>";
...
$brday = new DateTime($brday);
    ...
    echo "<li><a href='user-log-out.php' class='sign-o'>Sign Out</a></li>";
}
?></ul>
