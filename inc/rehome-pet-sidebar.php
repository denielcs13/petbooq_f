<div class="pet-reh fr-list rehome-pet-sideb">
<h2 class="fr-headnig">
	<div class="fr-headnig-l">
	<span class="user-icn-img">
	<a href="rehome-list.php">
	<div class="plus-i"><img src="images/rehome-cir-icon.png" alt=""></div>
...
<div class="p-sd-content">
				...
				$country = $res->country_name;
                            ...
                            require './dbcon.php';
                            $display_rehome = "SELECT * FROM  `pet_rehome` where country = '$country' and status = 1 ORDER BY RAND() LIMIT 4";
