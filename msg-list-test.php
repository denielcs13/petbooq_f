...
<div class="fr-ch-r-content">
    <h2 class="fri-name"><a class="fri-ch-li-row" href='about-fr.php?id=<?= $row['pet_unique_id'] ?>'><?= $row['pet_name'] ?></a></h2>
...
?>
                              ...
                              <?php
                             	$profileqry=mysqli_query($conn,"SELECT * FROM user_inf WHERE pet_unique_id='$_GET[user_id]'");
...
WHERE
    R.user_id_fk = U.pet_unique_id AND R.c_id_fk = '$_GET[id]'
ORDER BY
    R.cr_id ASC
