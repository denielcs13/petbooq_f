...
session_start();
//print_r($_POST);
//print_r($_SESSION['business_uniqueid']);
...
if (isset($_POST['commentid'])) {
    ...
    $pet_unique_comment_id = $_SESSION['business_unique_id'];
    ...
    mysqli_query($conn, $comment_insert);
     ...
     require './dbcon.php';
     $like_select = "select * from business where business_uniqueid = '" . $pet_unique_comment_id . "'";
     $display_name= mysqli_query($conn, $like_select);
    $comapny_name = mysqli_fetch_assoc($display_name);
     echo "<a href='#'>".$comapny_name['company_name']."</a>". $commenst;
