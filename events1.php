...
<div class="main-content user-pro-dtls-page usr-feed-page-nw about-page usr-feed-page  groups-page create-mem-pages event-page" id="about-load-ref">
...
<div class="pro-timeline">
                       <?php if($profileinfo1['e_profile_pic']=="") {
							...
							<?php
$grp_name=mysqli_query($conn,"SELECT page_name FROM events WHERE event_id='$_GET[id]' AND user_id_fk='$parent_id'");
