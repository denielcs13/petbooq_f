...
//                }
                    ...
                    if (mysqli_query($conn, $otp_verification)) {
                        ...
                        $mail->Host = 'smtp.petbooqtesting.com';             // Specify main and backup SMTP servers
                        $mail->SMTPAuth = true;                     // Enable SMTP authentication
                        $mail->Username = 'mythostest@petbooqtesting.com';          // SMTP username
                        $mail->Password = 'info@123'; // SMTP password
                        $mail->SMTPSecure = 'ssl';
                        $mail->Port = 465;
                        $mail->setFrom('mythostest@petbooqtesting.com', 'PetbooQ');
