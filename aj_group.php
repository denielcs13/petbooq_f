...
<div class="ajcontent">
		...
		<?php
		$disp_post=mysqli_query($conn,"SELECT * FROM updates WHERE update_id='$_GET[id]'");
		...
		?>
			<div class="one-col-post one-col-post-box" id="<?= $postres['update_id'] ?>">
...
<?php } ?>
                                ...
                                <div class="post-box-right">
										 ...
										 <img src="images/fr-pro-big-img.jpg">
										 <?php } else { ?>
		...
		<?php $user_like=mysqli_query($conn,"SELECT * FROM group_likes WHERE post_id='$postres[update_id]' AND liker_unique_id='$parent_id'"); 
										...
										<?php } ?>
											...
											$likeqry=mysqli_query($conn,"SELECT * FROM group_likes WHERE post_id='$postres[update_id]' AND liker_unique_id='$parent_id'");
												...
												<div class="comment-area" id="<?= $postres['update_id'] ?>ajx-comment-area">
												<?php
