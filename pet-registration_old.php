            ...
            <div class="main-content-inn">
                <div class="reg-left-sec">
                    <div class="reg-left-top">
						...
						<?php
$imdir="pet_owner/";
$randimgqry="SELECT * FROM rand_images order by RAND() LIMIT 3";
	 $imgresult=mysqli_query($conn,$randimgqry);
	 while($imrow=mysqli_fetch_assoc($imgresult)) {
		 ?>
                            <div class="tr-img-col"><div class="image"><img class="trending-img" src="<?= $imdir.$imrow['path'] ?>"></div></div>
...
<div class="tr-vd-col"><div class="vdo">
<section>


                <video id="my-video" class="video-js" controls preload="auto" width="640" height="237"
  poster="https://cdn.selz.com/plyr/1.5/View_From_A_Blue_Moon_Trailer-HD.jpg?v1" data-setup="{}">
                    ...
                    <div class="reg-form-sec">
                        <form action="#" method="post" name="registration" id="userregistration">
                            <div class="pt-dt">
                                ...
                                <?php if(empty($_POST["pet_name"])){echo "<p style='color:red'>".$error_name."</p>";}?>
                                ...
                                <?php if(empty($_POST["type_pet"])){echo "<p style='color:red'>".$error_typepet."</p>";}?>
                                <div class="form-row">
                                    <label>Date of Birth</label> 
                                    <div class="fld-r dob">
                                        <?php  if(empty($_POST["dob"]) && empty($_POST["month"]) && empty($_POST["year"])){echo "<p style='color:red'>".$error_date."</p>";}?>
                            ...
                            <div class="usr-dt">
                                ...
                                <?php if(empty($_POST["owner_name"])){echo "<p style='color:red'>".$error_owner_name."</p>";}?>    
                                ...
                                <?php if(empty($_POST["password"])){echo "<p style='color:red'>".$error_passwords."</p>";}?> 
                                ...
                                <?php if(empty($_POST["country"])){echo "<p style='color:red'>".$error_country."</p>";}?>
                                <div class="form-row">
                                    <label>Phone No.</label> 
                                    <div class="fld-r phn">
                                        <input type="text" placeholder="" value="+91" class="sml"/>
                                        <input type="text" placeholder="No." class="mid" name="mobile" id="mobile"/>
                                         <?php if(empty($_POST["mobile"])){echo "<p style='color:red'>".$error_mobile."</p>";}?>
                                    </div>
