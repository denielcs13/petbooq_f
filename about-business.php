...
<div class="main-content user-pro-dtls-page usr-feed-page-nw about-page usr-feed-page groups-page business-dtl-page width-80 abt-buss-new" id="about-load-ref">
...
</a></span><p class="user-nm"><a href="about3.php?id=<?= $userinf['business_uniqueid'] ?>"><?= $userinf['company_name'] ?></a></p></h2>
<a href="<?= $propost['url'] ?>">
<h3><?= $propost['title'] ?></h3>
...
<a href="aj_business.php?id=<?= $propost['id'] ?>&im=<?= $proimages[$i] ?> .ajcontent" data-featherlight="ajax">
<img src="<?= $proimages[$i] ?>"></a>
											...
											<?php if($propost['vid_count']>0) {
												...
												?>   
												<li class="pb-image-box">
											<a href="aj_business.php?id=<?= $propost['id'] ?>&vid=<?= $provid[$i] ?> .ajcontent" data-featherlight="ajax"><video width="230" height="200" controls>
