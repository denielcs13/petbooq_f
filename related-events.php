...
<button class="post-share-btn" id=""><i class="fa fa-user-plus"></i> Going</button>
<!--<button class="post-edit-button" id=""><i class="fa fa-pencil-square-o"></i><a href="edit-event.php?id=<?php echo $event_id;?>">Edit</a></button>-->
...
//                                            $description=$grpres['event_desc'];
	...
	<div class="fr-right">
	<span class="fr-nm"><a href="event-test.php?id=<?= $grpres['event_id'] ?>&name=<?= $grpres['event_name'] ?>" class="frn_profile"><?= $grpres['event_name'] ?></a></span>
