...
<html>
    ...
    <body>
        ...
        $userqry = mysqli_query($conn, "SELECT * FROM ngo_resgitration WHERE ngo_unique_id ='$_GET[id]'");
...
$ngo_id=$_GET['id'];
        ...
        <div class="main-content user-pro-dtls-page usr-feed-page-nw about-page usr-feed-page  groups-page" id="about-load-ref">
            <div class="main-content-inn col-three main-content-full">
                ...
                <?php
                $profileqry = mysqli_query($conn, "SELECT * FROM ngo_resgitration WHERE ngo_unique_id='$_GET[id]'");
                    ...
                    <div class="col-first">
                        <div class="two-col-post two-col-post-brdr">
                            <div class="user-pro-dtls">
								...
								<h2 class="ngo-name-ttl"><?= $profileinfo['ngo_name'] ?></h2>
                                    <div class="usr-pro-right">
                                        <div class="post-act-ins">
                                            <?php
                $blikeqry = mysqli_query($conn, "SELECT * FROM ngo_like WHERE ngo_id='$_GET[id]' AND user_id='$user_id'");
                                            ...
                                            <div class="hiddenclass" style="display:none;" id=<?= $user_id ?>></div>
                                        </div>
                                    </div>
                                </div>
