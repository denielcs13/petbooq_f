...
<?php require_once 'inc/header.php';  ?>
    <?php
        ...
        $pg_name=$_GET[name];
        require 'dbcon.php';
        $userqry = mysqli_query($conn, "SELECT * FROM pages WHERE page_id='$pg_id'");
...
<div class="grp-name"><h2><i class="fa fa-paw"></i><span class="grp-name-t">Pet Lovers</h2></span></div>
<div class="sidebar">
<ul>
...
<li><a href="#"><i class="fa fa-image"></i>Photos</a></li>
	...
	$image_tmpname=$_FILES['file']['tmp_name'];
		...
		//	}
            ...
            require './dbcon.php';
            $insert = "update  pages set  pg_profile_pic = '$target_path' where page_id = $pg_id";
           // print_r($insert);die;
    ...
    ?>
                               <?php
                                $pg_id=$_GET[id];
				$profileqry=mysqli_query($conn,"SELECT * FROM pages WHERE page_id='$pg_id'");
...
<div class="fr-list">
                                            ...
                                            <div class="">
												...
												<h2 class="fr-heading"> Page Members</h2>
...
FROM user_inf U, page_users G WHERE U.status =  '1'
