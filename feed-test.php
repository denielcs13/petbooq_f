...
<html>
    ...
    <body>
        <?php require_once 'inc/header_112.php'; ?>
                                ...
                                <div class="upload-btn uplbtn-top uplbtn-btm-t">
                                    ...
                                    <div class="upload-btn-hld upload-btn-hld-top">
                                        <div class="upload-btn-inhld" id="upload-post-img">
                                            ...
                                            <input name="files[]" value="upload" class="fl-img" type="file" multiple required>
                                ...
                                jQuery('.frn_req_acc').on('click', function (e) {
                                    ...
                                    jQuery.ajax({
                                        ...
                                        success: function (data) {
                                            ...
                                            jQuery('#' + acc_id + '.frn_req_acc').parent().html("ACCEPTED").parent().fadeOut(1000);
                                            jQuery('#friends-list').load(document.URL + ' #friends-list');
											  // jQuery('#' + acc_id + '.frn_req_acc').parent().parent().fadeOut(1000);
                                        }
                                    });
                                }),
