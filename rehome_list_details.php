                ...
                <div class="main-content-inn-left">
                    <div class="col-first">
                       <div class="two-col-post">
                         <h2 class="fr-heading"><span class="fr-h-l">ReHome a Pet List Details</span></h2>
                                <?php
                                //session_start();
                                //$pet_unique_id = $_SESSION['pet_unique_id'];
				//require './dbcon.php';
                                $pet_unique_id=$parent_id;
				$query_fetchs = "select * from pet_rehome WHERE user_id_fk = '$pet_unique_id'";
