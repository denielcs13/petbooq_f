...
<input type="text" name="web_name" placeholder="http://"/>
    ...
    <div class="sub-btn"><input type="submit" id="page-submit-act" name="submit" value="Save Page" /> <button id="page-create-nxt" class="nxt-btn">Next Step</button></div>
...
<button class="skip save-grn-btn">skip</button>
