...
?>
<?php
echo '<iframe src="https://www.facebook.com/plugins/share_button.php?href='.$actual_link.'&layout=button&size=small&mobile_iframe=true&appId=329340577474651&width=59&height=20" width="59" height="20" style="border:none;overflow:hidden" class="facebook-shr" scrolling="no" frameborder="0" allowTransparency="true"></iframe>';
?>
