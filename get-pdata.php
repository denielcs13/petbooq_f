...
$count = 1;
	...
	$postnameqry=mysqli_query($conn,"SELECT COALESCE((SELECT pet_name FROM user_inf WHERE pet_unique_id='$postres[child_post_id]'),(SELECT company_name FROM business WHERE business_uniqueid='$postres[child_post_id]')) AS pname");
