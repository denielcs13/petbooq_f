...
<?php require_once 'inc/header.php';  ?>
    <?php
        ...
        $gp_name=$_GET[name];
        require 'dbcon.php';
        $userqry = mysqli_query($conn, "SELECT * FROM groups WHERE group_id='$gp_id'");
...
<div class="grp-name"><h2><i class="fa fa-paw"></i><span class="grp-name-t">Pet Lovers</span></h2></div>
<div class="sidebar">
<ul>
...
<li><a href="gp-members-list.php?id=<?php echo $gp_id;?>"><i class="fa fa-users"></i>Members</a></li>
...
<li><a href="#"><i class="fa fa-image"></i>Photos</a></li>
	...
	$image_tmpname=$_FILES['file']['tmp_name'];
		...
		//	}
            ...
            require './dbcon.php';
            $insert = "update  groups set  gr_profile_pic = '$target_path' where group_id = $gp_id";
           // print_r($insert);die;
...
<div class="pro-timeline"><?php if($profileinfo['gr_profile_pic']=="") {
...
<button class="post-join-button" id=""><i class="fa fa-sign-in"></i>Join</button>
...
<div class="fr-list">
                                            ...
                                            <div class="">
												...
												<h2 class="fr-heading"> Group Members</h2>
									...
									<button class="crt-grp">Add Member</button>
										...
										<div class="fr-right">
										<div class="fri-name">
										<p class="ttl-lks"><a href="#">Pet Lovers</a></p>
